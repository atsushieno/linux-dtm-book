...
npm run pdf
gs -q -dNOPAUSE -dBATCH -dPDFSETTINGS=/prepress -sDEVICE=pdfwrite -sOutputFile=tmp_fontsembedded.pdf "articles/linux-dtm-book.pdf"
gs \
...
npm run pdf
gs -q -dNOPAUSE -dBATCH -dPDFSETTINGS=/prepress -sDEVICE=pdfwrite -sOutputFile=tmp_ebook.pdf "articles/linux-dtm-book.pdf"
...
pdftk tmp-front.pdf tmp_ebook.pdf cat output miscellaneous/linux-dtm-book.pdf
